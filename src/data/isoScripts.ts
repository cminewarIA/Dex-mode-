...
`
  },
  {
    ...
    language: 'python',
    description: 'Dashboard visual gráfico en Wayland con monitorización en tiempo real de ADB (Samsung DeX/Android por USB-C y Wi-Fi inalámbrico).',
...
class LapdockDashboardUI:
    ...
    def setup_ui(self):
        ...
        self.lbl_recent_event = tk.Label(
            self.footer,
            text="📡 Detección activa de puertos USB-C y Wi-Fi 5 GHz...",
            font=("DejaVu Sans", 9),
            fg="#94a3b8",
            bg="#0c101c"
        )
